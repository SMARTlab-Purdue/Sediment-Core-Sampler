...
from std_msgs.msg import Int32, Byte, Bool, String, Int32MultiArray
...
class SamplerController():
    def __init__(self):
        rospy.init_node('Sampler-controller', anonymous=True)
        ...
        self.linear_velocity = 0.f
        self.distance_traveled = 0.f
        ...
        self.rot_controller = RotaryController(rot_controller_kill, rot_controller_signal)
